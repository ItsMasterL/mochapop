...
@dso_cache = dso_local local_unnamed_addr global [304 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 172302429, ; hash 0xa45205d, from name: aot-MonoGame.Extended.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 345419967, ; hash 0x1496b0bf, from name: libaot-MonoGame.Extended.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MonoGame.Extended.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	...
	%struct.DSOCacheEntry {
		i64 478727970, ; hash 0x1c88cf22, from name: libaot-Android
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 565490802, ; hash 0x21b4b472, from name: Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 38
	%struct.DSOCacheEntry {
		i64 572605312, ; hash 0x22214380, from name: aot-Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	...
	%struct.DSOCacheEntry {
		i64 1218173476, ; hash 0x489bda24, from name: aot-Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 82
	...
	%struct.DSOCacheEntry {
		i64 1270963242, ; hash 0x4bc15c2a, from name: libaot-Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 86
	...
	%struct.DSOCacheEntry {
		i64 1723611333, ; hash 0x66bc38c5, from name: libaot-MonoGame.Extended
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MonoGame.Extended.dll.so
		ptr null; void* handle (0x0)
	}, ; 115
	...
	%struct.DSOCacheEntry {
		i64 2614049834, ; hash 0x9bcf3c2a, from name: Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 194
	...
	%struct.DSOCacheEntry {
		i64 3030373391, ; hash 0xb49fd40f, from name: MonoGame.Extended.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MonoGame.Extended.dll.so
		ptr null; void* handle (0x0)
	}, ; 218
	...
	%struct.DSOCacheEntry {
		i64 3534561512, ; hash 0xd2ad20e8, from name: aot-MonoGame.Extended
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MonoGame.Extended.dll.so
		ptr null; void* handle (0x0)
	}, ; 252
	...
	%struct.DSOCacheEntry {
		i64 3882769740, ; hash 0xe76e5d4c, from name: MonoGame.Extended
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-MonoGame.Extended.dll.so
		ptr null; void* handle (0x0)
	}, ; 274
